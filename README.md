...
Complete - Has a model for Blog with the following information: title and content
Complete - Has a controller for Blog
Complete - Has a controller action for index
Complete - Has a route for index
Complete - Has a view for index
